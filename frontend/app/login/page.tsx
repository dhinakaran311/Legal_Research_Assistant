...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Redirect directly to search page after successful login
      router.push('/search');
    } catch (err: any) {
        ...
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md p-8 rounded-2xl shadow-elevation-3 border border-gray-200/50 dark:border-slate-700/50 transform transition-all duration-300 hover:shadow-glass">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Sign in to access Legal Research Assistant
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center py-3 px-4 border border-gray-300 dark:border-slate-600 rounded-lg shadow-sm bg-white dark:bg-slate-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0"
              >
